...
1. The Facebook Chat Bot module that creates the connection between a Facebook page and your site. This needs to be enabled on your Drupal site. 
2. The customized workflow that's controlled by the demo_fb_messenger_bot. This includes OBIO specific workflows and responses. This needs to be enabled on your Drupal site. 
3. A Facebook page that serves as the source for the messenger bot. For the Obio demo, the Facebook page is https://www.facebook.com/OBIONYC/. 
