...
class EntityOperations {
  ...
  public function entityView(array &$build, EntityInterface $entity, EntityViewDisplayInterface $display, $view_mode) {
    ...
    if ($bundle_entity = $this->moderationInfo->loadBundleEntity($entity->getEntityType()->getBundleEntityType(), $entity->bundle())) {
      if (!$bundle_entity->getThirdPartySetting('workbench_moderation', 'display_moderation_information', TRUE)) {
        return;
      }
    }
    if (!$this->moderationInfo->isModeratableEntity($entity)) {
