...
class BundleModerationConfigurationForm extends EntityForm {
  ...
  public function form(array $form, FormStateInterface $form_state) {
    ...
    $form['display_moderation_information'] = [
      '#type' => 'checkbox',
      '#title' => t('Display moderation information on the latest version tab.'),
      '#description' => t('Disable this setting to prevent moderation information from automatically being added to the page on the latest version tab. This is useful when displaying moderation information in a block.'),
      '#default_value' => $bundle->getThirdPartySetting('workbench_moderation', 'display_moderation_information', TRUE),
      '#states' => [
        'visible' => [
          ':input[name=enable_moderation_state]' => ['checked' => TRUE],
        ],
  ...
  public function formBuilderCallback($entity_type, ConfigEntityInterface $bundle, &$form, FormStateInterface $form_state) {
    ...
    $bundle->setThirdPartySetting('workbench_moderation', 'display_moderation_information', $form_state->getValue('display_moderation_information'));
